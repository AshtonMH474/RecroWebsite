    ...
    return(
        <div className="border border-white/15 rounded-[8px] bg-[#1A1A1E] w-[300px] h-[265px] px-4 py-6">
            <div className="flex items-center mb-3 gap-x-3">
                ...
                <div data-tina-field={tinaField(test,'src')} className="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center border-2 border-gray-500">
            ...
            {test.quote && (
                <div data-tina-field={tinaField(test,'quote')}>
                    <TinaMarkdown
                    content={test.quote}
                    components={{
                        
                      p: ({ children }) => (
                        <p className="text-[#C2C2BC] font-bold noContentDes text-ellipsis text-[15px]">
