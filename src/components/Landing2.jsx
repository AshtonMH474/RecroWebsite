      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-x-22">
          ...
          <div className="lg:pl-20">
            ...
            {/* Buttons + Arrow together */}
            {/* Buttons + Arrow together */}
<div className="flex flex-col items-center lg:items-start">
  {/* Buttons row + arrow wrapper */}
  <div className="flex flex-col items-center">
    ...
    {/* Arrow always centered below buttons */}
    {props.arrow && (
      <motion.div
        initial={{ y: 0 }}
        animate={{ y: [0, 10, 0] }}
        ...
        className="mt-6 flex justify-center" // remove w-full so it matches buttons width
      >
        <ChevronDown
          onClick={() => {
            if (props.isSection) {
