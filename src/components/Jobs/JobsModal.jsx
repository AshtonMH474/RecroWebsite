...
function JobsModal({ onClose, job }) {
  useEffect(() => {
    ...
    // Lock scroll and freeze position
          ...
          <div className="flex-shrink-0 pb-3">
            ...
            <div className="flex items-center gap-x-2">
              <a
                ...
                target="_blank"
              >
                <button className="bg-primary flex justify-center gap-x-1 items-center px-4 h-[35px] rounded-[8px] hover:opacity-80 text-white">
