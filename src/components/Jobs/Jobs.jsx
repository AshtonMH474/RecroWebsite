...
function Jobs(props) {
  ...
  useEffect(() => {
    const handleJobs = async () => {
      ...
      const priortyJobs = allJobs.filter(
        (job) => job.priorityLevel == 'Critical' || job.priorityLevel == 'High'
      );
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center mt-32 pb-12">
          {props.jobsHeading && (
            <h2
              data-tina-field={tinaField(props, 'jobsHeading')}
        ...
        <div className="flex flex-col items-center justify-center  px-8">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://ats.recro.com/jobboard"
          >
      ...
      {expandedCardIndex !== null && (
        <JobsModal job={jobs[expandedCardIndex]} onClose={closeCard} />
      )}
    </>
  );
}
