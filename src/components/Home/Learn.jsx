...
function Learn(props) {
  ...
  return (
    <>
      <div
        ref={learnRef}
        className="bg-black overflow-hidden w-full mt-10 relative z-30 pb-20 min-full-screen-section" // Added min-full-screen-section class
      ...
      >
        <div
          ...
          style={{ minHeight: " 100vh" }} // Keep this if you explicitly want this inner div to always be 100% of its parent's height, which is now controlled by --vh
        >
          <motion.div
            style={{ opacity: contentOpacity }}
            className="pl-4 mt-16 sm:static md:w-[700px] mb-32"
