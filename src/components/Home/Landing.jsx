...
//     return(
//     <div style={{ minHeight: ' 100vh',overflowAnchor:'none' }} className="landing flex flex-col items-center justify-center  w-full">
...
function Landing(props) {
  return (
    <div
      // Removed inline minHeight: ' 100vh'. Now using CSS class.
      // style={{ minHeight: ' 100vh',overflowAnchor:'none' }}
      className="landing flex flex-col items-center justify-center w-full min-full-screen-section" // Added min-full-screen-section class
    >
      <div className="w-90 md:w-150" data-tina-field={tinaField(props, "heading")}>
        <TinaMarkdown
          ...
          components={{
            h1: (props) => (
              <h1
                className="text-[32px] md:text-[60px] font-bold text-center mb-4"
                {...props}
              />
            ),
            h3: (props) => (
              <h3 className="text-[16px] text-center secondary-text mb-6" {...props} />
            ),
          }}
        />
      </div>
