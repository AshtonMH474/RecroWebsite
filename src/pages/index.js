  ...
  return (
    <>
      ...
      {/* <div
        ...
        className="background Home bg-fixed bg-center bg-cover sm:bg-cover bg-contain flex flex-col items-end full-screen-section" // Added full-screen-section class
      >
        <motion.div
